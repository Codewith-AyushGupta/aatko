"use strict";(()=>{var e={};e.id=3324,e.ids=[3324],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},470:e=>{e.exports=require("sql.js")},7147:e=>{e.exports=require("fs")},1017:e=>{e.exports=require("path")},6121:(e,a,t)=>{t.r(a),t.d(a,{headerHooks:()=>E,originalPathname:()=>m,patchFetch:()=>g,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>y,staticGenerationAsyncStorage:()=>_,staticGenerationBailout:()=>f});var n={};t.r(n),t.d(n,{GET:()=>p,dynamic:()=>d});var i=t(5419),r=t(9108),s=t(9678),l=t(8070),o=t(1494);let d="force-dynamic";async function p(){try{let e=await (0,o.N8)();if(!e)return l.Z.json({classes:[]});try{let a=e.exec(`
    ...
    `);return _(t)}finally{a.close()}}async function g(e,a=50,t){let n=await c();if(!n)return[];try{let i=e.replace(/'/g,"''"),r=t?.replace(/'/g,"''"),s="";e&&t?s=`WHERE (api_name LIKE '%${i}%' OR label LIKE '%${i}%') AND type = '${r}'`:e?s=`WHERE api_name LIKE '%${i}%' OR label LIKE '%${i}%'`:t&&(s=`WHERE type = '${r}'`);let l=n.exec(`
      ...
      ORDER BY
        ...
        type, api_name
      LIMIT ${a}
    `);return _(l)}finally{n.close()}}async function x(e,a=2){let t=await c();if(!t)return{nodes:[],edges:[]};try{let n=new Set,i=[],r=[],s=(e,l)=>{if(n.has(e)||l>a)return;n.add(e);let o=t.exec(`SELECT * FROM nodes WHERE id = ${e}`),d=_(o);if(d[0]){let e=d[0];i.push({id:String(e.id),type:e.type.toLowerCase(),data:{label:e.api_name,nodeType:e.type},position:{x:0,y:0}})}let p=t.exec(`SELECT * FROM edges WHERE source_id = ${e}`),c=t.exec(`SELECT * FROM edges WHERE target_id = ${e}`),u=_(p),y=_(c);for(let a of[...u,...y]){r.push({id:`${a.source_id}-${a.target_id}-${a.edge_type}`,source:String(a.source_id),target:String(a.target_id),label:a.edge_type.replace(/_/g," "),animated:a.edge_type.includes("FLOW")});let t=a.source_id===e?a.target_id:a.source_id;s(t,l+1)}};s(e,0);let l=Array.from(new Map(r.map(e=>[e.id,e])).values());return{nodes:i,edges:l}}finally{t.close()}}}};var a=require("../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),n=a.X(0,[1638,6206],()=>t(6121));module.exports=n})();